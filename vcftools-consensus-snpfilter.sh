...
#vcftools --vcf $1 --remove-indels --recode --recode-INFO-all --maf 0.5 --max-missing 0.5 --out $(basename $1 .vcf)_maf50
vcftools --vcf $1 --remove-indels --recode --recode-INFO-all --maf 0.5 --min-alleles 2 --out $(basename $1 .vcf)_maf50_2
